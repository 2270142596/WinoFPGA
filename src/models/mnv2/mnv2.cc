...
// #include "models/mnv2/mobilenetv2.h"
// #include "models/mnv2/mobilenetv2_wino.h"

// #include "models/mnv2/mobilenetv2_wino.h"
// static void mnv2_init(void) {
//   tflite_load_model(mobilenetv2_wino, mobilenetv2_wino_len);
// }


// #include "models/mnv2/mobilenetv1_wino4.h"
// static void mnv2_init(void) {
//   tflite_load_model(mobilenetv1_wino4, mobilenetv1_wino4_len);
// }


#include "models/mnv2/mobilenetv1.h"
static void mnv2_init(void) {
  tflite_load_model(mobilenetv1, mobilenetv1_len);
}


// #include "models/mnv2/mobilenetv2_quant.h"
// static void mnv2_init(void) {
//   tflite_load_model(mobilenetv2_quant, mobilenetv2_quant_len);
// }
...
struct golden_test golden_tests[] = {
    {input_00001_7281, 3}, {input_00001_7425, 8}, {input_00002_2532, 8},
    {input_00002_25869, 0}, {input_00004_970, 6},
};
...
static int32_t mnv2_classify() {
  ...
  int32_t num=0;
  int8_t max=output[1]>output[0]?output[1]:output[0];
