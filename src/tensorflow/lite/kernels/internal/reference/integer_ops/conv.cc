...
void ConvPerChannel(const ConvParams& params, const int32_t* output_multiplier,
  ...
  //        (int)(dilation_width_factor == 0), (int)(output_activation_min == -128), (int)(batches == 1),
  //        (int)(input_height == output_height), (int)(filter_width ), (int)(bias_data),
  //        (int)(input_depth % 8) , (int)(output_depth % 8));
...
template void ConvPerChannel<std::int64_t>(
...
template void ConvPerChannel<std::int32_t>(
    const ConvParams& params, const int32_t* output_multiplier,
    const int32_t* output_shift, const RuntimeShape& input_shape,
    const int16_t* input_data, const RuntimeShape& filter_shape,
    const int8_t* filter_data, const RuntimeShape& bias_shape,
    const std::int32_t* bias_data, const RuntimeShape& output_shape,
    int16_t* output_data);
