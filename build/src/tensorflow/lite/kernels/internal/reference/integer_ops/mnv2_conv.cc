...
void Mnv2ConvPerChannel1x1(
  ...
  int input_depth = MatchingDim(input_shape, 3, filter_shape, 3);
  ...
  PERF_END(2);
  // printf(
  //     "input_depth:%d,output_depth:%d,channels_per_batch:%d,num_batches:%d\n",
  //     input_depth, output_depth, channels_per_batch, num_batches);
  ...
  //   CFU_MACC_RUN();
  //   // send one pixel per time

  // const int input_height = input_shape.Dims(1);
  // const int input_width = input_shape.Dims(2);
  //   for (int i = 0; i < input_height; i += params.stride_width) {
  //     for (int j = 0; j < input_width; j += params.stride_width) {
        
  //       LoadInputValues(input_ptr, input_depth_words);
  //       if (params.stride_width == 2) {
  ...
  //     }
  //     if (params.stride_width == 2) {
  //       input_ptr += input_depth_words * output_width;
  //     }
  //   }
