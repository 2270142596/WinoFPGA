...
# set num_tile= (pow(Input depth ,0.5)-2)/2,but now num_tile=2
            ...
            yield set_filter_val(pack_vals(4, 10, 4, -112))  # (0 1 2 3)
            yield set_filter_val(pack_vals(-6, 0, 152, 36))  # (0 1 2 3)
            yield set_filter_val(pack_vals(8, 110, 8, -12))  # (0 1 2 3)
            yield set_filter_val(pack_vals(-134, -32, 24, 4))  # (0 1 2 3)

#channel 1
            yield set_input_val(pack_vals(0, 0, 0, 23))
            yield set_input_val(pack_vals(0, 0, 23, 23))
            yield set_input_val(pack_vals(0, 23, 0, 23))
            yield set_input_val(pack_vals(23, 23, 23, 23))
            ...
            # Start calculation
            yield set_reg(33, 0)
            yield get_output(pack_vals(100, 100, 101, 101))
            yield get_output(pack_vals(100, 100, 101, 101))

#channel 2
            yield set_input_val(pack_vals(0, 0, 0, 145))
            yield set_input_val(pack_vals(0, 0, 145, 145))
            yield set_input_val(pack_vals(0, 145, 0, 145))
            yield set_input_val(pack_vals(145, 145, 145, 145))
            ...
            # Start calculation
            yield set_reg(33, 0)
            yield get_output(pack_vals(127, 127, 32, 32))
            yield get_output(pack_vals(127, 127, 32, 32))
